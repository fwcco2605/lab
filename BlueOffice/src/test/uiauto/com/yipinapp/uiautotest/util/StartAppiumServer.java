...
*/
        ...
        //启动appium服务
        Log.logInfo("start appium >> appium -p " + port + " -bp " + bPort + " --session-override" + " -U " + udid+" --command-timeout 600");
        Tools.cmdInvoke("appium -p " + port + " -bp " + bPort + " --session-override" + " -U " + udid+" --command-timeout 600");
