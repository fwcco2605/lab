...
import com.yipinapp.uiautotest.util.Tools;
...
public class WebOperate {
    ...
    public void acceptAlert() {
        ...
        Alert alert = WebOperate.driver.switchTo().alert();
        alert.accept();
    ...
    public void switchWindow() {
        Log.logInfo("切换到新开窗口");
        String nowHandle = WebOperate.driver.getWindowHandle();
        Set<String> handles = WebOperate.driver.getWindowHandles();
        for (String handle : handles) {
            if (handle != nowHandle) {
                WebOperate.driver.switchTo().window(handle);
            }
        }
    }
    ...
    public void scrollTo(WebElement element) {
        ...
        ((JavascriptExecutor) WebOperate.driver).executeScript("arguments[0].scrollIntoView();", element);
    }
