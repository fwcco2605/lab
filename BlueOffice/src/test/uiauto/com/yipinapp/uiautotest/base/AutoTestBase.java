package com.yipinapp.uiautotest.base;

import com.google.common.collect.ImmutableBiMap.Builder;
import com.yipinapp.uiautotest.base.operateFactory.AndroidOperate;
import com.yipinapp.uiautotest.base.operateFactory.AppOperate;
import com.yipinapp.uiautotest.base.operateFactory.IosOperate;
import com.yipinapp.uiautotest.base.operateFactory.WebOperate;
import com.yipinapp.uiautotest.util.*;
...
//            System.setProperty("log.appium.file", "appium_" + browser_name + ".log");
            ...
            try {
                if (null != remote_url && !"".equals(remote_url)) {
                    if (browser_name.toLowerCase().contains("chrome")) {
                        ...
                        driver = new EventFiringWebDriver(new RemoteWebDriver(new URL(remote_url), DesiredCapabilities.operaBlink())).register(executeListener);
                    }
                } else {
                    if (browser_name.toLowerCase().contains("chrome")) {
    ...
    public void afterMethod(String[] contents) {
        if (platformName.toLowerCase().contains("android") || platformName.toLowerCase().contains("ios")) {
            operateBase.backToHomePage(contents);
        }
    }*/
    ...
    public void afterSuit() {
        /*if (platformName.toLowerCase().contains("android") || platformName.toLowerCase().contains("ios")) {
            ((AppiumDriver<?>) driver).removeApp(AutoTestBase.appPackage);
        }*/
        driver.quit();
        service.stop();
    	if(!service.isRunning()){
